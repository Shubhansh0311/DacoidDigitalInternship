...
const WorkoutTracker = () => {
  ...
  return (
    <div className="max-w-[480px] border-1 min-h-full rounded-2xl shadow-lg shadow-gray-300 border-gray-400 h-[100%] pb-16 flex w-full  py-1 px-2 mx-auto  justify-center">
