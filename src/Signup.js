...
const Signup = () => {
  return (
    <div className="max-w-[480px] border-1 rounded-2xl pb-0[88px] shadow-lg shadow-gray-300 border-gray-400 h-[100%] flex w-full  py-1 px-2 mx-auto  justify-center">
      <div>
            ...
            <form class="space-y-6" action="#" method="POST">
              ...
              <div class="relative flex gap-x-3">
                ...
                <label for="consent" class="text-sm pt-[2px] text-gray-600">
                  ...
                  and{" "}
                  <a  href="/privacy"className="text-purple-400 underline">Privacy policy</a>
                </label>
              </div>
              <div className="py-6">
                <button
